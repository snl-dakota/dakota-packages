...
cmake \
  ...
  -D MUQ_HDF5_DIR:FILEPATH=/projects/sems/install/rhel6-x86_64/sems/tpl/hdf5/1.10.4/gcc/4.4.7/base \
  ...
  -D MUQ_ENABLEGROUP_SAMPLING_ALGORITHM=ON \
  ${MUQ_SRC_DIR}
...
# These settings avoid muq pulling its TPLs from the web but produces an install with missing symbols ...
#  -D MUQ_ENABLEGROUP_MODELING_FLANN:BOOL=OFF \
#  -D MUQ_ENABLEGROUP_DEFAULT=OFF \
