...
message(STATUS "In Sundials Build, CMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES}")
...
ExternalProject_Add(
	SUNDIALS
                ...
                CMAKE_ARGS -DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -DCMAKE_C_FLAGS=${CMAKE_C_FLAGS} -DBUILD_SHARED_LIBS=ON -DCMAKE_INSTALL_PREFIX=${SUNDIALS_INSTALL_DIR} -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DMPI_ENABLE=ON -DBUILD_CVODE=OFF -DBUILD_CVODES=ON -DBUILD_IDA=OFF -DBUILD_IDAS=ON -DBUILD_KINSOL=ON -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=ON
...
ExternalProject_Add(
	SUNDIALS
                PREFIX ${CMAKE_CURRENT_BINARY_DIR}/external/sundials
                URL ${SUNDIALS_EXTERNAL_SOURCE}
                CMAKE_ARGS -DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -DCMAKE_C_FLAGS=${CMAKE_C_FLAGS} -DBUILD_SHARED_LIBS=ON  -DCMAKE_INSTALL_PREFIX=${SUNDIALS_INSTALL_DIR} -DCMAKE_INSTALL_LIBDIR=lib -DBUILD_CVODE=OFF -DBUILD_CVODES=ON -DBUILD_IDA=OFF -DBUILD_IDAS=ON -DBUILD_KINSOL=ON -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=ON
                INSTALL_COMMAND make install
)
endif()
