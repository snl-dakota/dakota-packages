...
ExternalProject_Add(
	SPDLOG
                ...
                CMAKE_ARGS -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_INSTALL_PREFIX=${SPDLOG_INSTALL_DIR} -DCMAKE_OSX_ARCHITECTURES=${DCMAKE_OSX_ARCHITECTURES} -DSPDLOG_BUILD_EXAMPLE=OFF -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_POSITION_INDEPENDENT_CODE=ON
)
