...
! 07/06/2007 - "quiet" flag added to suppress output if desired
...
C|                                                                       |
C|   quiet -- Logical flag to suppress output messages - bjb             |
C|                                                                       |
C| On return                                                             |
C|                                                                       |
...
C+-----------------------------------------------------------------------+
      CALL DIRInit(f,fep,c,length,actdeep,point,anchor,free,
...
C+-----------------------------------------------------------------------+
      DO 50,i=1,n
C         x(i) = c(Minpos,i)*l(i)+l(i)*u(i)
         x(i) = ( c(Minpos,i)+u(i) )*l(i)
         u(i) = oldu(i)
         l(i) = oldl(i)
50    CONTINUE
C+-----------------------------------------------------------------------+
